...
<div class="wrapper fadeInDown">
  <div id="formContent">
    ...
    <div class="fadeIn first">
      <img src="@/assets/Caballo.png" id="icon" alt="User Icon" />
    </div>
    ...
    <form v-on:submit.prevent="Login">
      ...
      <input type="email" id="login" class="fadeIn second" name="login" placeholder="Ingresa tu email" required v-model="email">
      <input type="password" id="password" class="fadeIn third" name="login" placeholder="Ingresa tu contraseña" required v-model="password">
...
export default {
  ...
  methods: {
    Login() {
      ...
      axios.post('https://localhost:44386/api/Usuarios/Login', jsonbody)
        .then(response => {
